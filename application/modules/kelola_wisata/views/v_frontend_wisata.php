...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
  ...
  <!-- Lokasi Section -->
  <section id="about" class="pattern-style-1 has-overlay">
    <div class="container">
      <h1 class="subtitle">
...
<script type="text/javascript">
  ...
  //Wisata
  var air_terjun_bajuin = L.marker([-3.7733834, 114.8113069], {
    icon: iconMarker
  }).addTo(mymap).bindTooltip("Air Terjun Bajuin").openPopup();
  air_terjun_bajuin.url = "buki/puskesmas_buki.php";
  air_terjun_bajuin.on('click', function() {
