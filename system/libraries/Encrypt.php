...
class CI_Encrypt
{
    ...
    function _xor_merge($string, $key)
    {
        ...
        for ($i = 0; $i < strlen($string); $i++) {
            $str .=
                substr($string, $i, 1) ^ substr($hash, $i % strlen($hash), 1);
        }
        return $str;
    }
    // --------------------------------------------------------------------
    ...
    {
        $this->_hash_type =
            ($type != 'sha1' and $type != 'md5') ? 'sha1' : $type;
    }
    // --------------------------------------------------------------------
    /**
